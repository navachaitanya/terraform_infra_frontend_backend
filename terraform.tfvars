...
app_ec2_asg_name              = "app_ec2_asg"    # EC2 - Auto Scaling  Group Name, ex: app_ec2_asg
app_ec2_launch_template_name  = "app_ec2_lt_asg" # EC2 - Auto Scaling Launch Template Name
app_instance_name             = "terrafrom"         # EC2 - App Name or EC2 Name, This will the EC2 Instance Name, ex: test
app_instance_type             = "t3.small"       # EC2 - Instance Type, ex: "t3.small"
app_ec2_sg_name               = "ec2_sg"         # EC2 - Security Group Name, ex: test_sg
app_ec2_monitoring            = true             # EC2 - Enable Monitoring for EC2 Instance "true" or "false"
root_block_device_volume_type = "gp2"            # EC2 - Root volume type, ex: "gp2"
root_block_device_volume_size = "30"             # EC2 - Root volume size, ex: "30"

####################### ALB and ALB Security Group - Required Variables ######################
app_loadbalancer_name         = "terrafrom-lb"   # ALB - App Loadbalancer name, ex: test-lb
...
rds_name                     = "devrdsterrafrom" # RDS - DATABASE NAME - rds identifier name and rds name - should be Letters and Numbers and NO UNDERSCORES
rds_identifier_name          = "devrdsterrafrom" # RDS - Identifier name and rds name - should be Letters and Numbers and NO UNDERSCORES and NO hyphens
...
rds_username                 = "terrafromappusr" # RDS - Username - should be ne Letters and Numbers and NO UNDERSCORES
rds_password                 = "terrafrom!123"   # RDS - Password change this as per requirement
rds_sg_name                  = "rds_sg"       # RDS - Security Group Name, ex: test_sg
rds_multi_az                 = false
...
##### PUBLIC S3 Bucket #######
public_s3_bucket_name = "terrafrom-app" # S3 - Bucket Name Should be ne Letters, Numbers, hyphens only and NO UNDERSCORES
...
##############################
##### PRIVATE S3 Bucket ######
private_s3_bucket_name = "terrafrom-app" # S3 - Bucket Name Should be ne Letters, Numbers, hyphens only and NO UNDERSCORES
#public_s3_bucket_acl   = "public-read"     # S3
...
##############################
###### LOGS S3 Bucket ########
private_s3_logs_bucket_name = "terrafrom-app-logs" # S3 - Bucket Name Should be ne Letters, Numbers, hyphens only and NO UNDERSCORES
